...
class DiaryBot:
    ...
    def select(self, update: Update, context: CallbackContext) -> None:
        ...
        context.bot.send_message(chat_id=update.effective_chat.id, text = f"Base de dados {title} selecionada!")
    ...
    def setup_dispatcher(self):
        ...
        self.dispatcher.add_handler(MessageHandler(Filters.update.message,self.create))
